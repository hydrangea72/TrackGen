function catToColour(cat = -999, accessible = true) {
    console.log("catToColour function called");
    try {
        ...
        console.error("Error in catToColour function:", error);
    }
}

document.querySelector("#close").addEventListener("click", () => {
    console.log("#close click event listener called");
    try {
        document.querySelector("#image-container").classList.add("hidden");
    } catch (error) {
        console.error("Error in #close click event listener:", error);
    }
});
...
mapSelector.addEventListener('change', async () => {
    console.log("mapSelector change event listener called");
    try {
        ...
        console.error("Error in mapSelector change event listener:", error);
    }
});
...
buttons.forEach(button => {
    button.addEventListener("click", async () => {
        console.log("Button click event listener called");
        try {
...
async function getMapBlob() {
    console.log("getMapBlob function called");
    try {
        ...
        console.error("Error in getMapBlob function:", error);
    }
}
...
function createMap(data, accessible) {
    ...
    try {
        ...
        console.error("Error in createMap function:", error);
    }
}